...
#define ETAR_AP_SSID "eTar"
#define ETAR_AP_PASSWD "Balute!123"

#define SLEEP_DELAY_MINUTES 30   //sleep delay more than 3 mins causes freezing
#define SHUTDOWN_DELAY_MINUTES 30